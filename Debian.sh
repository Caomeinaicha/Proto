...
if ! grep -q "inet6" /etc/network/interfaces; then
	...
	echo "    dns-nameservers 2001:4860:4860::8888 2606:4700:4700::1111" >> /etc/network/interfaces
fi
...
d-i netcfg/get_ip6nameservers string 2001:4860:4860::8888 2606:4700:4700::1111
